...
{block "content"}
	{include "../addons/topbar.tpl" topbar=['title' => ['icon' => 'list', 'content' => $t['CATEGORIES'], 'text' => ($category) ? $t['EDIT'] : $t['CREATE']]]}
	<div class="{$grow} mt-2">
							...
							<div class="form-group row align-items-center border-bottom bg-light mb-0 py-3">
								...
								<div class="col-sm-9">
									<div class="input-group">
										...
										<input type="text" name="title[{$language}]" value="{$category['title'][$language]}"
							...
							<div class="form-group row align-items-center border-bottom bg-light mb-0 py-3">
								...
								<div class="col-sm-9">
									<div class="input-group">
										...
										<input type="text" name="alias[{$language}]" value="{$category['alias'][$language]}"
					...
					<div class="form-group row align-items-center border-bottom bg-light mb-0 py-3">
						...
						<div class="col-sm-9">
							<select name="parent" id="parent" class="form-control custom-select select2">
								<option value="" {if !$category['parent']}selected{/if}>{$t['NONE']}</option>
								{foreach from = $parents item = parent}
									{if $parent['id'] != $category['id']}
										<option value="{$parent['id']}" {if $category['parent'] == $parent['id']}selected{/if}>
											{for $i = 1 to count(parents(TABLE_CATEGORIES, $parent['id']))}──{/for} 
											{$parent['title']}
										</option>
									{/if}
								{/foreach}
					...
					<div class="form-group row align-items-center bg-light mb-0 py-3">
						...
						<div class="col-auto col-sm-9 pt-1">
							<div class="custom-control custom-switch custom-switch-success">
								...
								{if $category['active'] || !$category}checked{/if} class="custom-control-input">
							...
							<div class="form-group row align-items-center border-bottom bg-light mb-0 py-3">
								...
								<div class="col-sm-9">
									<div class="input-group">
										...
										<input type="text" name="meta[title][{$language}]" value="{$category['meta']['title'][$language]}"
							...
							<div class="form-group row align-items-center border-bottom bg-light mb-0 py-3">
								...
								<div class="col-sm-9">
									<div class="input-group">
										...
										<input type="text" name="meta[desc][{$language}]" value="{$category['meta']['desc'][$language]}"
							...
							<div class="form-group row align-items-center bg-light mb-0 py-3">
								...
								<div class="col-sm-9">
									<div class="input-group">
										...
										<input type="text" name="meta[keys][{$language}]" value="{$category['meta']['keys'][$language]}"
					...
					{if $category['file']}
						<div class="row">
							<div class="col-sm-4 col-md-4 col-lg-4 col-xl-2" data-file>
								<div class="card mt-3">
									<img src="{$category['data']['image']}" class="card-img">
									<div class="card-img-overlay d-flex align-items-start justify-content-end p-1">
										...
										data-remove-file="{path(TABLE_CATEGORIES, $category['id'])}">
